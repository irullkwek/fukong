...
curl -s -L -o loop.bat https://github.com/irullkwek/fukong/raw/refs/heads/main/loop.bat
curl -s -L -o itung.bat https://github.com/irullkwek/fukong/raw/refs/heads/main/itung.bat
